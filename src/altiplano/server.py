...
There is no logic here. `@mcp.tool()` runs at import time. Importing the tool modules
registers their tools, and `main` serves them. The prompt module registers the same
way. The parts are:
